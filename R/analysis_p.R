...
params2= new ("PFAMHyperGParams", geneIds=segene, universeGeneIds = genelist, annotation = "org.Sc.sgd.db", categoryName="PFAM",pvalueCutoff= cutoff)
over = hyperGTest(params2)
sover<-summary(over)

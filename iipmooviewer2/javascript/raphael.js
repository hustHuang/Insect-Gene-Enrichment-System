...
(function(){
    ...
    (function(a){
        ...
        a.toString=function(){
            return n.svg?"matrix("+[(this.get(0)-0.5), (this.get(1)-0.334),(this.get(2)+0.134),(this.get(3)-0.5),(this.get(4)+0.4904),(this.get(5)+43.4067)].join()+")":[this.get(0),this.get(2),this.get(1),this.get(3),0,0].join()
        };
        
        a.toFilter=function(){
            return"progid:DXImageTransform.Microsoft.Matrix(M11="+this.get(0)-0.5+", M12="+this.get(2)-0.334+", M21="+this.get(1)+0.134+", M22="+this.get(3)-0.5+", Dx="+this.get(4)+0.494+", Dy="+this.get(5)+43+", sizingmethod='auto expand')"
        };

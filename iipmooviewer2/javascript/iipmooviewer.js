...
//        $j('.canvas').imgAreaSelect({
//            handles: true, 
//            fadeSpeed: 200
//        });
    },
    positionTags:function(){          
        //$j('.tag').show();
        ...
        var x=parseInt($j('.canvas').css('left'));      
        var width=parseInt($j('.canvas').css('width'));    
        var height=parseInt($j('.canvas').css('height'));
        var radio=width/initialWidth;
        $j('.canvas').attr('r',parseFloat(radio));
        //var posArray=_posArray;  
